                    ...
                    if ( $_POST ) {
                        ...
                        if ( $error == 0 ) {
                            ...
                            if ( is_wp_error($status) ) {
                                ...
                                //assigning contributor role by default
                                $user = get_user_by('email', $email);
                                if (!in_array('contributor', $user->roles)) {
                                    $user->remove_role('subscriber');
                                    $user->add_role('pending_contributor');
                                }
                            ...
                            <div class="col-md-5 manual-register-form">
                                ...
                                <form action="" method="post">
                                    ...
                                    <p>
                                        ...
                                        <input type="password" name="password" placeholder="Type your Password Here" class="register-input mb-4" /><br />
                                    </p>
                                    <input type="submit" id="register-submit-btn" class="mb-4" name="submit" value="SignUp" />
                                </form>

                                <p>Already have an account? <a href="/church/church-a/wp-admin">Login Here</a></p>
